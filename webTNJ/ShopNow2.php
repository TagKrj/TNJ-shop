...
<head>
    ...
    <link rel="stylesheet" href="ShopNow3.php">
    <link rel="stylesheet" href="ShopNow4.php">
...
<body>
    ...
    <header>
        ...
        <div class="icons">
            ...
            <a href="SignUp&Login.php" class="fas fa-user"></a>
    ...
    <div class="shop">
        ...
        <div class="input">
            ...
            <div class="navbar">
                ...
                <a href="ShopNow2.php" class="hightlight">bracelets</a>
                <a href="ShopNow3.php">necklaces</a>
        ...
        <div class="products">
            ...
            <h1 class="heading">bracelets <span>products</span></h1>
            ...
            <div class="pages">
                <a href="ShopNow1.php" class="fa fa-arrow-left"></a>
                <a href="ShopNow3.php" class="fa fa-arrow-right"></a>
            </div>
        </div>
