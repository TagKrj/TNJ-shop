    ...
    <div class="details">
        ...
        <div class="info-product">
            <div class="fit-info-product">
                ...
                <h4>Brand: Lili</h4>
                <p>Tìm kiếm một món trang sức tinh tế và sang trọng để tôn vinh vẻ đẹp của bạn? Hãy khám phá Vòng
                    kim
                    cương lấp lánh - Tuyệt tác từ LiLi. Chiếc vòng được chế tác tỉ mỉ từ những viên kim
                    cương lấp lánh, mang đến vẻ đẹp rực rỡ và đẳng cấp cho người sở hữu.</p>
                <div class="quantity">
                    <input type="number">
