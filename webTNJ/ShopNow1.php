...
<head>
    ...
    <title>Sản phẩm nhẫn</title>

    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css" integrity="sha512-SnH5WK+bZxgPHs44uWIX+LLJAJ9/2PkPKZ5QiAj6Ta86w+fsb2TkcmfRyVX3pBnMFcV7oQPJkl9QevSCWr3W6A==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link rel="stylesheet" href="ShopNow1.css">
    <!-- font chữ -->
...
<body>
    ...
    <div class="shop">
        ...
        <div class="input">
            ...
            <div class="navbar">
                <a href="ShopNow1.php" class="hightlight">Nhẫn</a>
                <a href="ShopNow2.php">Vòng tay</a>
                <a href="ShopNow3.php">Vòng cổ</a>
        ...
        <div class="products">
            ...
            <h1 class="heading">Sản phẩm <span>nhẫn</span></h1>
            ...
            <div class="pages">
                <a href="ShopNow2.php" class="fa fa-arrow-right"></a>
            </div>
        </div>
